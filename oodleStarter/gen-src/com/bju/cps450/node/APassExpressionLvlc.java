...
public final class APassExpressionLvlc extends PExpressionLvlc
{
    private PExpressionLvl3 _expressionLvl3_;

    public APassExpressionLvlc()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APassExpressionLvlc(
    ...
    {
        ((Analysis) sw).caseAPassExpressionLvlc(this);
    }
